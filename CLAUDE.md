...
- `ai_strat/` — AI strategies as function pointers (`ai_strategy.h`); `ai_strat_random`, `ai_strat_valuebased`, `ai_strat_combo_threshold`, `ai_strat_borealis`, `ai_strat_balanced_rules`, `ai_strat_heuristic`, and `ai_strat_tactical` are functional, the rest (`simplemc1`, `ismcts1`) are design stubs.
