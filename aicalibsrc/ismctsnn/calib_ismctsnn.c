...
//   numsim,seed,agent_a,agent_b,<21 params A>,<21 params B>,wins_a,wins_b,draws
...
#define ISMCTSNN_PARAM_ARGC 21 // fields in ISMCTSParams, ai_strat_ismcts1.h's declared order
...
{ fprintf(stderr,
          ...
          "<21 ISMCTSParams fields, ai_strat_ismcts1.h's declared order> "
          "<same 21 for Player B>\n"
          "   or: %s --print-defaults\n",
          prog, prog);
} // print_usage

// Parses one seat's 21-field ISMCTSParams block starting at argv[offset],
...
{ ISMCTSParams d = ismctsnn_get_default_params();
  printf("{\n"
         ...
         d.nn_value_use_mover_seat ? "true" : "false");
} // print_defaults_json
