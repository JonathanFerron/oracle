...
{ MODE_NONE = 0,
  ...
  MODE_STDA_CLI,     /* Standalone text command line interface : TODO add this mode to the remainder of this file */
  ...
  MODE_CLIENT_CLI,   /* Client text command line interface : TODO add this mode to the remainder of this file */
...
{ printf("Usage: %s [OPTIONS]\n\n", prog);
  ...
  // -l and -sl could be used for stda.cli
  ...
  // -L and -cl could be used for client.cli
