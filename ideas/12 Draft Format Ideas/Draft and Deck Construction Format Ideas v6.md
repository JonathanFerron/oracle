...
Oracle could implement inverse drafting strategy: draft normally but aiming for worst possible cards, after completion players swap drafted pools, build and play with opponent's sabotaged deck, teaches card evaluation through opposition, fun casual variant.
