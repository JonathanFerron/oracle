...
│   ├── stda_tui.c/h          # Standalone TUI (ncurses)
│   ├── stda_gui.c/h          # Standalone GUI (SDL3)
│   └── stda_sim.c/h          # Standalone interactive simulation
│
├── ui/                        # User interface components
│   ├── cli/
│   │   ├── cli_display.c/h   # CLI output formatting
│   │   ├── cli_input.c/h     # CLI input parsing
│   │   ├── cli_game.c/h      # CLI game loop
│   │   └── cli_callbacks.c/h # CLI event callbacks
│   ├── tui/
│   │   ├── tui_main.c/h      # TUI initialization
│   │   ├── tui_render.c/h    # ncurses rendering
│   │   ├── tui_input.c/h     # TUI input handling
│   │   └── tui_windows.c/h   # Window management
│   ├── gui/
│   │   ├── gui_main.c/h      # SDL3 initialization
│   │   ├── card_renderer.c/h # Card compositing
│   │   ├── font_manager.c/h  # Font loading/caching
│   │   ├── texture_cache.c/h # Image caching
│   │   ├── layout.c/h        # Responsive layout
│   │   └── input.c/h         # Input abstraction
...
│   ├── client_main.c/h       # Client entry point
...
### 5. **Modes** - Clean Entry Points

- Each mode is self-contained
- Modes orchestrate core + UI + strategies
- No cross-dependencies between modes
- Easy to add new modes

### 6. **UI** - Three-Tier Structure

- `cli/`, `tui/`, `gui/` directories for each interface
- Split by concern: display, input, game loop
- Shared localization and configuration
- Callbacks allow core to notify UI of events

### 7. **Interactive** - Player Agency
...
### 8. **Actions** - Network & MCTS Foundation
...
### 9. **Visibility** - Information Hiding
...
### 10. **Network** - Client/Server Split
...
### 12. **Rating** - Self-Contained System
...
### 13. **Config** - Centralized Settings
...
3. **Phase 3**: Split oversized files (`stda_cli.c` → CLI triplet)
